    ...
    return (
        <div className="d-flex flex-column text-center">
            ...
            <h3 style={{fontWeight: '500'}}>
                {t('no_employer_profile_h3')}
            </h3>
            <p className="mb-3">{t('no_employer_profile_p')}</p>
            ...
            <button className="theme-btn btn-style-three mb-4">
                <i className="fa fa-user me-2" /> {t('no_employer_profile_button')}
            </button>
            </Link>
...
export default NoEmployerProfile